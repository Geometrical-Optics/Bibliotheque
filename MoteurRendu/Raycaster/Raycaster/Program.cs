...
Image[] materials = new[] { new Texture(
        "C:/Users/yvanf/OneDrive/Documents/Raycaster/Raycaster/Raycaster/Ressources/Doom/SUPPORT_5D.png").CopyToImage(),
    new Texture(
        "C:/Users/yvanf/OneDrive/Documents/Raycaster/Raycaster/Raycaster/Ressources/Doom/SLIME_1A.png").CopyToImage(),
    new Texture(
...
{(4.5,4.5,0, 0.5, 1, (new Texture(
    "C:/Users/yvanf/OneDrive/Documents/Raycaster/Raycaster/Raycaster/Ressources/cat.jpg")).CopyToImage())};

RaycastSprite[] SpritesList = new RaycastSprite[]
{
    new RaycastSprite((4.5f,4.5f,0),(0.25f,1,0.5f),
        (new Texture("C:/Users/yvanf/OneDrive/Documents/Raycaster/Raycaster/Raycaster/Ressources/monstre.png")).CopyToImage(),
        (0,0,0))
};
